...
public class ReqRespLogFilter implements Filter {
    ...
    private static org.slf4j.Logger log = LoggerFactory.getLogger(ReqRespLogFilter.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            final StringBuilder logMessage = new StringBuilder()
                    ...
                    .append(requestMap)
                    .append("\nHEADERS:\n")
                    .append( getHeaderNamesAndValues(httpServletRequest) )
                    .append("REQUEST BODY:\n")
                    .append(bufferedRequest.getRequestBody())
                    .append("\nREMOTE ADDRESS:\n")
                    .append(httpServletRequest.getRemoteAddr());
            if ( bufferedRequest != null && bufferedResponse != null && chain != null)  {
